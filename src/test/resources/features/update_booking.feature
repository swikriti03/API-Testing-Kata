...
Feature: Update Booking
  ...
  Scenario Outline: Updating an existing booking should fail if mandatory fields are missing or invalid values are passed
    ...
    Examples:
      ...
      |           | Anguez   | true        | Rocky@test.com  | 787865432213 | 2025-08-10 | 2025-08-17 | size must be between 3 and 18, Firstname should not be blank                                         |
      | Rocky     |          | true        | Rocky@test.com  | 787865432213 | 2025-08-10 | 2025-08-12 | size must be between 3 and 30, Lastname should not be blank                                          |
      | 123@/     | Anguez   | true        | Rocky@test.com  | 787865432213 | 2025-08-10 | 2025-08-17 | Firstname should be a valid string                                                                   |
      | Rocky     | 123@/    | true        | Rocky@test.com  | 787865432213 | 2025-08-10 | 2025-08-12 | Lastname should be a valid string                                                                    |
      | j         | Anguez   | false       | Rocky@test.com  | 787865432213 | 2025-08-10 | 2025-08-15 | size must be between 3 and 18                                                                        |
      | Rocky     | v        | false       | Rocky@test.com  | 787865432213 | 2025-08-10 | 2025-08-15 | size must be between 3 and 30                                                                        |
      | Rocky     | Anguez   | false       | jvik!gmail.com  | 787865432213 | 2025-08-10 | 2025-08-15 | must be a well-formed email address                                                                  |
      | Rocky     | Anguez   | false       | Rocky@test.com  | 123          | 2025-08-10 | 2025-08-15 | size must be between 11 and 21                                                                       |
      | Rocky     | Anguez   | false       | jRocky@test.com | 787865432213 |            | 2025-08-15 | must not be null                                                                                     |
      | Rocky     | Anguez   | false       | Rocky@test.com  | 787865432213 | 2025-08-10 |            | must not be null                                                                                     |
      | Rocky     | Anguez   | false       |                 | 787865432213 | 2025-08-10 | 2025-08-12 | must not be empty                                                                                    |
      | Rocky     | Anguez   | false       |                 |              | 2025-08-10 | 2025-08-12 | must not be empty, size must be between 11 and 21, must not be empty                                 |
      |           |          | false       | Rocky@test.com  | 787865432213 | 2025-08-10 | 2025-08-15 | Lastname should not be blank, Firstname should not be blank, size must be between 3 and 30, 3 and 18 |
      | Rocky     | Anguez   |             | Rocky@test.com  | 66765451326  | 2025-08-10 | 2025-08-12 | Depositpaid should not be blank                                                                      |
